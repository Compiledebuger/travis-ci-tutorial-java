[![Build Status](https://app.travis-ci.com/Compiledebuger/travis-ci-tutorial-java.svg?branch=master)](https://app.travis-ci.com/Compiledebuger/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/Compiledebuger/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/Compiledebuger/travis-ci-tutorial-java)
...
[Click here for the example using GitHub Actions instead of Travis CI](https://github.com/Compiledebuger/github-ci-tutorial-java)

# How To Start

1. [Fork](https://github.com/Compiledebuger/travis-ci-tutorial-java/fork) this Repository
